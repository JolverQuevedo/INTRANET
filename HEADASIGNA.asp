...
<tr>
	<td align= left WIDTH=35% ROWSPAN=2>
		...
		style="cursor:hand;"
		onclick="javascript: top.window.location.replace('SUBMENU.ASP?TIPO=10');">
	</td>
	<td align= CENTER>
		<font face=arial size= 3 color=DarkBlue><B>ASIGNA CCT A PO'S
		</b></font>
	</td>
...
<SCRIPT>
function ENVIO()
{	cad = 'detASIGNA.asp?cli='+trim(thisForm.CLI.value)
	//alert(cad)
