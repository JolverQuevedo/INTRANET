  ...
  // Pretende ingresar mas de lo solicitado....
   if ((parseFloat(aten) > parseFloat(xrec)) && trim(document.all.PWD.value)==''){  
       ...
       // alert(cad)
        ...
        var x = window.confirm("No puede recibir m�s de lo pendiente \nDesea un codigo para Liberarlo?")
        if (x) 
        {   window.alert("NO cierre esta ventana, le llegar� un mail con la autorizaci�n ")
        ...
        {   var z = window.confirm("Ingresa c�digo de validaci�n?")
            if (z) 
